...
func createDB(dao *Dao) error {
	...
	dao.AddEndpoint(process.Endpoint{ID: 0, Endpoint: "/websocket", Methods: http.MethodGet, MimeType: "", Filename: "", Body: asset("websocket.json"), CreateTime: now, UpdateTime: now, DeletedAt: ""})
